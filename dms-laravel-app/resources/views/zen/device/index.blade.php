    ...
    <x-ui.atoms.card>
      <table class="min-w-full divide-y divide-gray-200 text-gray-600">
        <thead class="bg-white">
          <tr>
            <x-html.table-head-column>Appareil</x-html.table-head-column>
            <x-html.table-head-column>Fournisseur</x-html.table-head-column>
            <x-html.table-head-column>Addresse IP </x-html.table-head-column>
