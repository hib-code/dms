<section class="px-5 mb-10">
  ...
  <form action="{{ route('device.index') }}" method="post">
    ...
    <div class="mb-4 text-sm">
      <label class="block mb-1 font-normal text-gray-500 tracking-wider mb-1" for="vendor">Fournisseur</label>
      <input class="w-full h-8 px-2 text-gray-700 placeholder-gray-600 border rounded-md focus:shadow-outline"
             id="vendor"
             name="vendor"
             type="text"
    ...
    <div class="mb-4 text-sm">
      <label class="block mb-1 font-normal text-gray-500 tracking-wider mb-1" for="ip_address">Addresse IP </label>
      <input class="w-full h-8 px-2 text-gray-700 placeholder-gray-600 border rounded-md focus:shadow-outline"
             id="ip_address"
             name="ip_address"
             type="text"
